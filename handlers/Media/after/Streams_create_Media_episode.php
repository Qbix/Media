...
function Media_after_Streams_create_Media_episode ($params) {
    ...
    //runs generating clips with AI. Fow now, it is only for episodes that was generated by Media_YoutubeClipGenerator class
    if ($params['inserted'] && strpos($episode->name, 'yt_') !== false) {
        //Media_YoutubeClipGenerator::processEpisodeIntoClips($episode);
        return;
    }
