 ...
 * @return {void}
 */
function Media_fbLive_post($params = array())
{
	...
	if(!isset($params['action'])) {
		...
		if($params['action'] == 'start') {
			Media_fbLive_startStreaming($params);
		} else if($params['action'] == 'end') {
			Media_fbLive_endStreaming($params);
		}
	}
}

function Media_fbLive_startStreaming($params) {
...
function Media_fbLive_endStreaming($params) {
