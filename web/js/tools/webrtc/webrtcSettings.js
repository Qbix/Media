...

        {
            ...
            createUI: function () {
                ...
                settingsNavigationInner.appendChild(createNavitem({
                    ...
                    text: 'General',
                    icon: 'gearsSettings',
                    className: 'settings-item-scheduler'
                }));
            ...
            showSettings: function (key) {
                ...
                if (key == 'permissions') {
                    ...
                    if(!tool.webrtcSchedulerTool) {
                        tool.activateWebrtcSchedulerTool().then(function () {
                            showSettings();
                        });
                    } else {
                        showSettings();
                    ...
                    function showSettings() {
                        tool.settingsParams.innerHTML = '';
                        tool.settingsParams.appendChild(tool.webrtcSchedulerTool.widgetElement);
                    }
                } else if(key == 'limits') {
            ...
            activateWebrtcSchedulerTool: function () {
                var tool = this;
                return new Promise(function (resolve, reject) {
                    Q.activate(
                        Q.Tool.setUpElement('DIV', 'Media/webrtc/scheduler', {
                            publisherId: tool.roomStream.fields.publisherId,
                            streamName: tool.roomStream.fields.name,
                            showSaveButton: true,
                            showAttendeesInviteForm: true,
                            showScheduleLivestreamCheckbox: false,
                        }),
                        {},
                        function () {
                            tool.webrtcSchedulerTool = this;
                            resolve();
                        }
                    );
                });
