...

        {
            importChildModules: function () {
                ...
                return new Promise(function (resolve, reject) {
                    Q.addScript([
                        ...
                        '{{Media}}/js/tools/webrtc/livestreamingEditor/RecordingPopup.js',
                        '{{Media}}/js/tools/webrtc/livestreamingEditor/RTMPStreaming.js',
                        '{{Media}}/js/tools/webrtc/livestreamingEditor/RTMPSender.js',
                        '{{Media}}/js/tools/webrtc/livestreamingEditor/PeerToPeerStreaming.js',
                        '{{Media}}/js/tools/webrtc/livestreamingEditor/StreamingAndRecording.js',
            ...
            create: function() {
                ...
                function createPopup() {
                    ...
                    var streamingToSection = tool.streamingAndRecording = new Q.Media.WebRTC.livestreaming.StreamingAndRecording(tool);
                    generalControls.appendChild(streamingToSection.element);
